...
class DatePickerView: UIView, UIGestureRecognizerDelegate {
    ...
    private func setupView() {
        ...
        containerView >>> self >>> {
            $0.snp.makeConstraints {
                ...
                $0.bottom.equalToSuperview().offset(ItemSize.datePickerViewHeight)
            }
        ...
        touchArea >>> containerView >>> {
            $0.snp.makeConstraints {
                $0.bottom.equalTo(dPicker.snp.top)
                $0.leading.trailing.equalToSuperview()
            ...
            if moveY > 50 {
                DispatchQueue.main.async {
                    UIView.animate(withDuration: 0.2, animations: {
                        self.containerView.transform = CGAffineTransform(translationX: 0, y: ItemSize.datePickerViewHeight)
                    })
                }
